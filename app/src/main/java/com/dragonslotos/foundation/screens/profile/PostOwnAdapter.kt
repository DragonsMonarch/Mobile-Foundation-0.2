...
class PostOwnAdapter: RecyclerView.Adapter<PostOwnAdapter.PostsOwnViewHolder>() {
    var data: List<Post> = emptyList();
    lateinit var bundle: Bundle
    lateinit var mContext: Context
    class PostsOwnViewHolder(view: View) : RecyclerView.ViewHolder(view)

    public fun upData(list: List<Post>){
        data = list
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostsOwnViewHolder {
        ...
        return PostsOwnViewHolder(inflater)
    }

    override fun onBindViewHolder(holder: PostsOwnViewHolder, position: Int) {
