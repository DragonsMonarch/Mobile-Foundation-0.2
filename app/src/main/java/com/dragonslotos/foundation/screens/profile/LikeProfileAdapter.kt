...
class LikeProfileAdapter: RecyclerView.Adapter<LikeProfileAdapter.PostsLikeViewHolder>()  {
    var data: List<Post> = emptyList();
    lateinit var bundle: Bundle
    lateinit var mContext: Context
    class PostsLikeViewHolder(view: View) : RecyclerView.ViewHolder(view)

    public fun upData(list: List<Post>){
        data = list
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostsLikeViewHolder {
        ...
        return PostsLikeViewHolder(inflater)
    }

    override fun onBindViewHolder(holder: PostsLikeViewHolder, position: Int) {
